...
export async function Example() {
  ...
  const pageContent = await fs.readFile(
    `../apps/pool-site/app/[lang]/${filename}`,
    'utf8'
  )
...
> [SWR i18n example](https://github.com/shuding/nextra/blob/main/apps/pool-site/app/%5Blang%5D/graphql-eslint/%5B%5B...slug%5D%5D/page.tsx)
> source code.
