...
<ExampleCode example="pool-site" filePath="middleware.ts" metadata="{1}" />
...
the
[SWR i18n example](https://github.com/shuding/nextra/blob/c9d0ffc8687644401412b8adc34af220cccddf82/apps/pool-site/app/%5Blang%5D/not-found.ts).
