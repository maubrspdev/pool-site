...
${(await fs.readFile(`../apps/docs/src/app/docs/${filename}`, 'utf8'))
  .split('\n')
  .slice(2, -1)
  .join('\n')}
~~~`
...
>
> Checkout Nextra's
> [docs website](https://github.com/shuding/nextra/tree/main/apps/docs) and
> [i18n website example](https://github.com/shuding/nextra/tree/main/apps/pool-site).
